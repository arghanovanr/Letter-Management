...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url() ?>SuratKeluar/TambahDisposisi/<?= $disposisi_keluar['nomor_urut'] ?>" method="POST">
                <div class="mb-3">
                    <label for="SuratDari" class="form-label">Surat dari</label>
                    <input type="text" class="form-control" id="SuratDari" name="suratdari" aria-describedby="emailHelp" value="<?= $surat_keluar['alamat_pengirim'] ?>">
                </div>
                <div class="mb-3">
                    <label for="NoSurat" class="form-label">No Surat</label>
                    <input type="text" class="form-control" id="NoSurat" name="nosurat" value="<?= $surat_keluar['nomor'] ?>">
                </div>
                <div class="mb-3">
                    <label for="TanggalSurat" class="form-label">Tanggal surat</label>
                    <input type="date" class="form-control" id="TanggalSurat" name="tanggalsurat" value="<?= $surat_keluar['tanggal'] ?>">
                </div>
                <div class="mb-3">
